...
const Footer = () => {
  return (
    <footer className="border-t border-[#24332D] bg-[#0E1513] py-8">
      <div className="container mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
        <span className="text-sm text-[#737F78]">
        ...
        <div className="flex items-center gap-4">
          {[
            ...
            <a key={href} href={href} target="_blank" rel="noopener noreferrer" className="text-[#A4AEA8] hover:text-[#78C6A3] transition-colors">
              <Icon size={18} />
            </a>
          ))}
        </div>
